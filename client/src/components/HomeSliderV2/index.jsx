    ...
    return (
        <>
            <Swiper
                ...
                className="homeSliderV2 relative z-0"
                ...
                {banners.map((item, index) => (
                    <SwiperSlide key={item.subtitle}>
                        <div className="item w-full h-[65vh] rounded-md overflow-hidden">
                            ...
                            <div className="info absolute top-0 -right-full opacity-0 transition-all duration-500 w-[43%] h-full flex flex-col justify-center p-8 in-[.swiper-slide-active]:right-0 in-[.swiper-slide-active]:opacity-100 ">
