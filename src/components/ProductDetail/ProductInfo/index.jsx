...
const ProductInfo = ({ product }) => {
  ...
  return (
    <div className="flex-1">
      ...
      <div className="mb-4">⭐⭐⭐⭐⭐ (4 Reviews)</div>
      ...
      <span className="inline-block mb-4 bg-green-100 text-green-600 px-3 py-1 rounded-full text-sm">
        IN STOCK
      </span>
      ...
      <div className="flex items-center gap-4 mb-4">
        <div className="flex items-center rounded">
          <button
            ...
            className="px-4 py-1 rounded-full bg-gray-200 text-[24px] font-medium cursor-pointer"
          >
            -
          </button>
